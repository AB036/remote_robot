...
class SocketConnection(Thread) :
    ...
    def __start_connection(self) :
        ...
        self.client_connection, info = self.__connection.accept()
        ...
        return self.__connection, self.client_connection
    ...
    def __listen(self) :
        ...
        if header == b'\x01' : #If received a new robot message
            new_robot_id = self.client_connection.recv(1)[0]
    ...
    def __send_command(self,robot_id,command_id) :
        self.client_connection.sendall(b'\x0a'+bytes([robot_id])+bytes([command_id]))
