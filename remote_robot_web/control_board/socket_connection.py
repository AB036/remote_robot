...
class SocketConnection(Thread) :
    ...
    def __listen(self) :
        ...
        if header == b'\x01' : #If received a new robot message
            ...
            print("Received new frame with pixel 1 [{},{},{}] and pixel 2 [{},{},{}]".format(SocketConnection.frame[0,0,0],
                                                                    SocketConnection.frame[0,0,1],
                                                                    SocketConnection.frame[0,0,2],
                                                                    SocketConnection.frame[0, 1, 0],
                                                                    SocketConnection.frame[0, 1, 1],
                                                                    SocketConnection.frame[0, 1, 2]),
                  )
